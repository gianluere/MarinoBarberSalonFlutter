                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        onChanged: (value) => setState(() => descrizione = value),
                      ),
                        ...
                        children: [
                          Row(
                            children: List.generate(5, (index) {
                              ...
                              bool isHalfStar = rating >= starValue - 0.5 && rating < starValue;
                              return GestureDetector(
                                onTap: () {
                                  setState(() {
                                    rating = rating == starValue - 0.5 ? starValue : starValue - 0.5;
                                  });
                                },
                                child: Icon(
                                  isFullStar
                                      ...
                                      ? Icons.star_half
                                      : Icons.star_border,
                                  color: isFullStar || isHalfStar ? Colors.amber.shade700 : Colors.black,
                                  size: 30,
                                ),
                              );
                            }),
                    ...
                    onPressed: () {
                      listaRecensioniViewModel.inserisciRecensione(
                        recensione: Recensione(
                          nome: "${userViewModel.dati?.nome} ${userViewModel.dati?.cognome}",
                          stelle: rating,
